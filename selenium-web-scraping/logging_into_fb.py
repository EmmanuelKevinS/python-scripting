...
def main():
    ...
    time.sleep(2)
    #filling in email
    driver.find_element(by='id', value="email").send_keys("gerrard_emmanuel@hotmail.com")
    time.sleep(2)
    #filling in pw
    driver.find_element(by='id', value="pass").send_keys("lucas21" + Keys.RETURN)
    ...
    #clicking done 
    driver.find_element(by='xpath',value="/html/body/div[1]/div/div[1]/div/div[4]/div/div/div[1]/div/div[2]/div/div/div/form/div/div[2]/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div/div[1]/div/span/span").click()
    #typing message
    ...
    #posting
    driver.find_element(by='xpath', value="email").send_keys("/html/body/div[1]/div/div[1]/div/div[4]/div/div/div[1]/div/div[2]/div/div/div/form/div/div[1]/div/div/div/div[3]/div[2]/div/div/div[1]/div/span/span").click()
    time.sleep(5)
